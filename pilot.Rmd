...
# add all possibilties for 
melted_df$relationship <- ifelse(grepl("1|4|7|10|13", melted_df$factor_demo), "closefriend",
                       ifelse(grepl("2|5|8|11|14", melted_df$factor_demo), "acquaintance",
                       ifelse(grepl("3|6|9|12|15", melted_df$factor_demo), "dontknow", NA)))

melted_df$location <- ifelse(grepl("1|2|3", melted_df$factor_demo), "gym",
                   ifelse(grepl("4|5|6", melted_df$factor_demo), "home", 
                    ifelse(grepl("7|8|9", melted_df$factor_demo), "street",
                    ifelse(grepl("10|11|12", melted_df$factor_demo), "control",NA))))

# make another column
melted_df$`platformaudience` <- sub("^[^_]*_", "", melted_df$factor_demo)

# some lack all demo, remove those
demo.df <- melted_df[!is.na(melted_df$Age) & melted_df$Age !="",]
